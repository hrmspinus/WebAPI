...
namespace HRMS.WebAPI.Controllers
{
    ...
    public class EmployeeDetailsController : ControllerBase
    {
        ...
        {
            return _employeedetailsrepo.CreateEmployeeDetails(employeeDetails.FirstName,employeeDetails.MiddleName,
                employeeDetails.LastName,employeeDetails.DateOfBirth,employeeDetails.Age,employeeDetails.Gender,
                employeeDetails.Email,employeeDetails.PhoneNumber,employeeDetails.EmergencyContactNumber,
                employeeDetails.Location,employeeDetails.MaritalStatus);
        }
    }
}
